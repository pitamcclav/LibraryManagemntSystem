              ...
              <div class="container">
                  <div class="row justify-content-center">
                      <div class="col-lg-5 text-center mx-auto">
                          <h1 class="text-white mb-2 mt-5">The E-Library</h1>
                          <p class="text-lead text-white">Bringing you all kinds of books from popular authors across the world at your
                              disposal!</p>
                      </div>
                  </div>
              </div>
